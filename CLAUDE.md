...
- 住みやすさスコアのtarget値（2026-07-17更新）: コンビニ27・スーパー8・病院7・飲食店140軒。349駅中341駅の実データの75パーセンタイル値（上位25%の駅で満点になる基準）に統一。大都市駅のみ7駅で決めた初期暫定値からの見直し。詳細は`backend/scoring.js`・設計書5.1参照。
